...
$category_name     = JHtml::link(
	JRoute::_( 'index.php?option=' . CW_APP_NAME . '&view=crosswords&id=' . $item->catid . ':' . $item->category_alias ),
...
<div class="container-fluid no-space-left no-space-right crosswords-wrapper">
                ...
                <div class="media-body">
                    ...
                    <div class="crossword-controls margin-top-10">
						<?php if ( ( ! $user->guest && $user->id == $item->created_by && $user->authorise( 'core.edit', CW_APP_NAME ) )
                            ...
                            <a href="<?php echo JRoute::_( 'index.php?option=' . CW_APP_NAME . '&view=crosswords&task=edit&id=' . $item->id . ':' . $item->alias ); ?>"
	...
	<?php if ( $commentsComponent != 'none' ): ?>
        <div id="cwcomments" class="row-fluid">
            <div class="span12">
				...
				<?php
				$fburl = JRoute::_( 'index.php?option=' . CW_APP_NAME . '&view=crosswords&task=view&id=' . $item->id . ':' . $item->alias, false, - 1 );
    ...
    <div style="display: none;">
        ...
        <span id="url_solve_question"><?php echo JRoute::_( 'index.php?option=' . CW_APP_NAME . '&view=crosswords&task=solvequestion&id=' . $item->id
		                                                    . $home_itemid ); ?></span>
        <span id="url_solve_crossword"><?php echo JRoute::_( 'index.php?option=' . CW_APP_NAME . '&view=crosswords&task=solvecrossword&id=' . $item->id
		                                                     . $home_itemid ); ?></span>
    ...
    <div id="confirm-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="confirmModalLabel" aria-hidden="true">
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary btn-confirm-solve-crossword" aria-hidden="true"><i
                        class="icon-thumbs-up icon-white"></i> <?php echo JText::_( 'COM_CROSSWORDS_CONFIRM' ); ?></button>
        </div>
    </div>
</div>