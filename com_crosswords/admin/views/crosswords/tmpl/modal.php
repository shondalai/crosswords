...
JHtml::addIncludePath( JPATH_ROOT . '/components/com_crosswords/helpers/html' );
...
?>
<form action="<?php echo JRoute::_( 'index.php?option=com_crosswords&view=crosswords&layout=modal&tmpl=component&function=' . $function . '&' . JSession::getFormToken()
    ...
    <fieldset class="filter clearfix">
        <div class="btn-toolbar">
            ...
            <div class="btn-group pull-left">
                ...
                <button type="button" class="btn hasTooltip" title="<?php echo JHtml::tooltipText( 'JSEARCH_FILTER_CLEAR' ); ?>" data-placement="bottom"
        ...
        <div class="filters pull-left">
            ...
            <select name="filter_category_id" class="input-medium" onchange="this.form.submit()">
				...
				<?php echo JHtml::_( 'select.options',
					JHtml::_( 'category.options', 'com_content', [ 'filter.language' => [ '*', $this->state->get( 'filter.forcedLanguage' ) ] ] ), 'value', 'text',
