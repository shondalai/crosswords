...
$categories = JHtml::_( 'category.categories', 'com_crosswords' );
...
?>
<form class="crossword-form" action="<?php echo JRoute::_( 'index.php?option=com_crosswords&view=crosswords&task=save_crossword' ); ?>" method="post">
    ...
    <fieldset>
		...
		<?php if ( $item->id == 0 ): ?>
            ...
            <div class="clearfix">
                ...
                <select name="difficulty_level" id="difficulty_level" size="1">
                    <option value="1"<?php echo $item->level == 1 ? ' selected="selected"' : ''; ?>><?php echo JText::_( 'COM_CROSSWORDS_LEVEL_EASY' ); ?></option>
                    <option value="2"<?php echo $item->level == 2 ? ' selected="selected"' : ''; ?>><?php echo JText::_( 'COM_CROSSWORDS_LEVEL_MODERATE' ); ?></option>
                    <option value="3"<?php echo $item->level == 3 ? ' selected="selected"' : ''; ?>><?php echo JText::_( 'COM_CROSSWORDS_LEVEL_HARD' ); ?></option>
                </select>
            </div>
		<?php endif; ?>
        ...
        <div class="clearfix">
			...
			<?php echo JHTML::_( 'select.genericlist', $categories, 'catid', [ 'list.select' => $item->catid ] ); ?>
        </div>
...
<div style="display: none;">
    ...
    <span id="url_get_questions"><?php echo JRoute::_( 'index.php?option=com_crosswords&view=crosswords&task=get_questions' ); ?></span>
</div>
