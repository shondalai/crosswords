...
<div id="cj-wrapper">
    <form action="<?php echo JRoute::_( 'index.php?option=com_communitypolls&view=poll&id=' . (int) $this->item->id ); ?>" method="post" name="adminForm" id="adminForm"
          class="form-validate">
            ...
            <div class="span4">
                <div class="answers">
					<?php foreach ( $this->item->answers as $i => $answer ): ?>
                        <label><i class="icon-asterisk"></i> <?php echo $answer->title . ' (' . $answer->votes . ' ' . strtolower( JText::plural( 'COM_COMMUNITYPOLLS_VOTES',
