...
$assoc      = APP_VERSION >= 3 ? Associations::isEnabled() : true;
?>
...
<form action="<?php echo Route::_( 'index.php?option=com_crosswords&view=keywords' ); ?>" method="post" name="adminForm" id="adminForm">
			...
			<?php else : ?>
                <table class="table table-striped" id="keywordList">
                    ...
                    <tr>
                        ...
                        <th>
							<?php echo HTMLHelper::_( 'searchtools.sort', 'COM_CROSSWORDS_QUESTION', 'a.question', $listDirn, $listOrder ); ?>
                        </th>
                        <th>
							<?php echo HTMLHelper::_( 'searchtools.sort', 'COM_CROSSWORDS_CATEGORY', 'a.catid', $listDirn, $listOrder ); ?>
                        </th>
					...
					<?php foreach ( $this->items as $i => $item ) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid; ?>">
                            ...
                            <td class="center">
                                <div class="btn-group">
									<?php echo HTMLHelper::_( 'jgrid.published', $item->published, $i, 'keywords.', $canChange, 'cb', '0000-00-00 00:00:00', '0000-00-00 00:00:00' ); ?>
                                </div>
                            </td>
                            <td class="has-context">
                                <div class="pull-left">
									<?php if ( $item->checked_out ) : ?>
										<?php echo HTMLHelper::_( 'jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'keywords.', $canCheckin ); ?>
									<?php endif; ?>
									...
									<?php if ( $canEdit || $canEditOwn ) : ?>
                                        <a href="<?php echo Route::_( 'index.php?option=com_crosswords&task=keyword.edit&id=' . $item->id ); ?>"
                                           title="<?php echo Text::_( 'JACTION_EDIT' ); ?>">
											<?php echo $this->escape( $item->title ); ?></a>
									<?php else : ?>
                                        <span title="<?php echo Text::sprintf( 'JFIELD_ALIAS_LABEL',
											$this->escape( $item->title ) ); ?>"><?php echo $this->escape( $item->title ); ?></span>
									<?php endif; ?>
                                </div>
                            </td>
                            <td>
