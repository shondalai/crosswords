...
class CrosswordsViewKeyword extends HtmlView {
	...
	public function display( $tpl = null ) {
		...
		else
		{
			...
			ToolbarHelper::title( Text::_( 'COM_CROSSWORDS_PAGE_KEYWORD_DETAILS' ), 'pencil-2 keyword-add' );
	...
	protected function addToolbar() {
		...
		$canDo = $this->canDo;
		ToolbarHelper::title( Text::_( 'COM_CROSSWORDS_PAGE_' . ( $checkedOut ? 'VIEW_KEYWORD' : ( $isNew ? 'ADD_KEYWORD' : 'EDIT_KEYWORD' ) ) ),
			'pencil-2 keyword-add' );
		...
		else
		{
			...
			ToolbarHelper::cancel( 'keyword.cancel', 'JTOOLBAR_CLOSE' );
		}
	}
