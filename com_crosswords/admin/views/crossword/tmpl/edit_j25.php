...
<form action="<?php echo JRoute::_('index.php?option=com_crosswords&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			<legend><?php echo empty($this->item->id) ? JText::_('COM_CROSSWORDS_NEW_CROSSWORD') : JText::sprintf('COM_CROSSWORDS_EDIT_CROSSWORD', $this->item->id); ?></legend>
	...
	<div class="width-40 fltrt">
		...
		<?php  $fieldSets = $this->form->getFieldsets('attribs'); ?>
			...
			<fieldset class="panelform">
				...
				<?php if ( $this->canDo->get('core.admin')   ):  ?>
					<?php  echo JHtml::_('sliders.panel', JText::_('COM_CROSSWORDS_SLIDER_EDITOR_CONFIG'), 'configure-sliders'); ?>
						<fieldset  class="panelform" >
							<ul class="adminformlist">
		...
		<?php if ($params['show_urls_images_backend']): ?>
			<?php echo JHtml::_('sliders.panel', JText::_('COM_CROSSWORDS_FIELDSET_URLS_AND_IMAGES'), 'urls_and_images-options'); ?>
				<fieldset class="panelform">
				<ul class="adminformlist">
					<li>
	...
	<?php if ($this->canDo->get('core.admin')): ?>
		<div class="width-100 fltlft">
			<?php echo JHtml::_('sliders.start', 'permissions-sliders-'.$this->item->id, array('useCookie'=>1)); ?>
				...
				<?php echo JHtml::_('sliders.panel', JText::_('COM_CROSSWORDS_FIELDSET_RULES'), 'access-rules'); ?>
				<fieldset class="panelform">
