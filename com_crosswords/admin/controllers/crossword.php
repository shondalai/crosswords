...
class CrosswordsControllerCrossword extends JControllerForm
{
	public function __construct($config = array())
	{
		...
		if ($this->input->get('return') == 'featured')
		{
			...
			$this->view_item = 'crossword&return=featured';
		}
	}
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($user->authorise('core.edit', 'com_crosswords.crossword.' . $recordId))
		{
			return true;
		}
		...
		if ($user->authorise('core.edit.own', 'com_crosswords.crossword.' . $recordId))
		{
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_crosswords&view=crosswords' . $this->getRedirectToListAppend(), false));
