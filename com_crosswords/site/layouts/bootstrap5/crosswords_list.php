                    ...
                    <div class="d-flex flex-row">
                        ...
                        <div class="w-100">
                            <div class="crossword-title-wrap">
								...
								{
									?>
                                    <small class="text-muted text-success" title="<?php echo JText::_( 'COM_CROSSWORDS_TOPIC_LOCKED' ) ?>" data-bs-toggle="tooltip"><i
								...
								{
									?>
                                    <small class="text-muted" title="<?php echo JText::_( 'COM_CROSSWORDS_ATTACHMENTS' ) ?>" data-bs-toggle="tooltip"><i
								...
								{
									?><a href="<?php echo JRoute::_( $crosswordUri ); ?>" class="fs-5 fw-light crossword-title"><?php echo $this->escape( $item->title ); ?></a><?php
								}
								else
								{
									...
									$fullURL = JRoute::_( 'index.php?option=com_users&view=login&Itemid=' . $itemId . '&return=' . base64_encode( $crosswordUri ) );
									?>
                                    <a href="<?php echo $fullURL; ?>" class="register">
										<?php echo JText::_( 'COM_CROSSWORDS_REGISTER_TO_READ_MORE' ); ?>
                                    </a>
									<?php
								}
								?>
                            ...
                            <ul class="list-inline forum-info">
                                ...
                                <li class="list-inline-item text-muted">
									...
									if ( $profileComponent != 'none' )
									{
										...
										echo JText::sprintf( 'COM_CROSSWORDS_POSTED_BY', $profileLink );
									}
									else
									{
										echo JText::sprintf( 'COM_CROSSWORDS_POSTED_BY', $author );
									}
									?>
                                </li>
								<?php if ( $params->get( 'list_show_parent', 1 ) == 1 ): ?>
                                    <li class="list-inline-item text-muted">
										<?php echo JText::sprintf( 'COM_CROSSWORDS_CATEGORY_IN',
											JHtml::link( CrosswordsHelperRoute::getCategoryRoute( $item->catid, $item->language ), $item->category_title ) ); ?>
                                    </li>
								<?php endif; ?>
							...
							<?php if ( $params->get( 'list_show_intro' ) ): ?>
                                <div class="text-muted"><?php echo JHtml::_( 'string.truncate', strip_tags( $item->introtext ),
						...
						<?php if ( $params->get( 'list_show_hits', 1 ) == 1 ): ?>
                            <div class="d-none d-sm-block ms-2">
                                <div class="card card-<?php echo $theme; ?> item-count-box">
                                    ...
                                    <div class="card-footer text-nowrap text-muted item-count-caption"><?php echo JText::plural( 'COM_CROSSWORDS_HITS', $item->hits ); ?></div>
                                </div>
                            </div>
						<?php endif; ?>
                    </div>
...
{
	?>
    <div class="alert alert-info"><i class="fa fa-info-circle"></i> <?php echo JText::_( 'COM_CROSSWORDS_NO_TOPICS' ) ?></div>
	<?php
}
