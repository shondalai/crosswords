...
<div class="container">
	...
	<div class="row">
		...
		<div class="<?php echo $rowClass;?>">
			<div class="controls">
				<?php echo JLayoutHelper::render('joomla.html.batch.item', ['extension' => 'com_cjforum']); ?>
			</div>
		</div>
		<?php endif; ?>
		<div class="<?php echo $rowClass;?>">
        ...
        <div class="<?php echo $rowClass;?>">
            <div class="controls">
				<?php echo JLayoutHelper::render('joomla.html.batch.workflowstage', ['extension' => 'com_cjforum']); ?>
            </div>
        </div>
		<?php endif; ?>
	</div>
