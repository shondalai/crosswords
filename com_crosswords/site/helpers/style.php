...
class CrosswordsHelpersStyle
{
	public static function load($site = false, $customTag = true)
	{
		...
		{		
			CJFunctions::add_css_to_document($document, JURI::base().'components/com_crosswords/assets/css/cj.crosswords.admin.min.css', $customTag);
			CJFunctions::add_script(JURI::base().'components/com_crosswords/assets/js/cj.crosswords.admin.min.js', $customTag);
		}
